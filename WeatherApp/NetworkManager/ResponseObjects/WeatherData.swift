...
class WeatherData: Codable {
    ...
    init(coord: Coord, weather: [Weather], base: String, main: Main, visibility: Int, wind: Wind, snow: Snow, clouds: Clouds, dt: Int, sys: Sys, timezone: Int, id: Int, name: String, cod: Int) {
        self.coord = coord
